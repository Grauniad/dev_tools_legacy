/*
 * CefBaseLifeSpanDefaultHandler.h
 *
 *  Created on: 8 Feb 2015
 *      Author: lhumphreys
 */

#ifndef CEF_BASE_DEFAULTS_LIFE_SPAN_H__
#define CEF_BASE_DEFAULTS_LIFE_SPAN_H__
 ...
 * shutdown).
 */
class CefBaseLifeSpanDefaultHandler: public CefLifeSpanHandler {
public:
	/**
	 * C'tor - initialise members...
	 *
	 */
	CefBaseLifeSpanDefaultHandler();

	/**
	 * D'tor - nothing to do (but see ref counting...)
	 */
	virtual ~CefBaseLifeSpanDefaultHandler();
...
private:
	...
	IMPLEMENT_REFCOUNTING(CefBaseLifeSpanDefaultHandler);
};
